...
class wpsimplegallery {
    ...
    private function admin_thumb($id) {
        ...
        ?>
        <li><a href="<?php echo admin_url('post.php?post='.$id.'&action=edit'); ?>" target="_blank"><img src="<?php echo $image[0]; ?>" width="<?php echo $image[1]; ?>" height="<?php echo $image[2]; ?>" /></a><a href="#" class="wpsimplegallery_remove"><?php echo __('Remove', 'wpsimplegallery'); ?></a><input type="hidden" name="wpsimplegallery_thumb[]" value="<?php echo $id; ?>" /></li>
        <?php
    }
