...
function tg_button_func($atts, $content) {
	...
	$shadow_color = '#'.grandportfolio_hex_darker(substr($bg_color, 1), 12);
...
function tg_social_icons_func($atts, $content) {
	...
	{
		$return_html.='<li class="flickr"><a target="_blank" title="Flickr" href="http://flickr.com/people/'.esc_attr($pp_flickr_username).'"><i class="fa fa-flickr"></i></a></li>';
	}
