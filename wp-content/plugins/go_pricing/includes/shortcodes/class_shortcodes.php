...
class GW_GoPricing_Shortcodes {
    ...
    public function pricing_table_sc( $atts, $content = null ) {
        ...
        if ( !empty( $data ) ) {
            ...
            $pricing_table = json_decode( $data );

            if ( empty( $pricing_table ) ) {
                return '<p>' . __( 'Invalid pricing table data given.', 'go_pricing_textdomain' ) . '</p>';
            }
        }
...
$custom_inline_styles[] = ob_get_clean();
            ...
            if ( !empty( $column_style_data['type'] ) ) {
                ...
                $header_classes = apply_filters( 'go_pricing_front_header_classes',
                    ...
                    [
                        'pricing_table' => $pricing_table,
                        'col_index' => $col_index,
                         'col_style_type' => !empty($column_style_data) && !empty($column_style_data['type']) ? $column_style_data['type'] : null
                    ]
                );
    ...
    public function video_sc( $atts, $content = null ) {
        ...
        $mp4_src = $mp4_src != '' ? '<source src="' . esc_attr($mp4_src) . '" type="video/mp4">' : '';
        $webm_src = $webm_src != '' ? '<source src="' . esc_attr($webm_src) . '" type="video/webm">' : '';
        $ogg_src = $ogg_src != '' ? '<source src="' . esc_attr($ogg_src) . '" type="video/ogg">' : '';
        $poster_src = $poster_src != '' ? $poster_src : $this->plugin_url . 'assets/images/blank.png';

        return '<video controls="controls"' . ( $autoplay != '' ? $autoplay : '' ) . ( $loop != '' ? $loop : '' ) . ( $poster_src != '' ? ' poster="' . esc_attr($poster_src) . '"' : '' ) . '>' . $mp4_src . $webm_src . $ogg_src . '<img src="' . esc_attr($poster_src) . '" title="No video playback capabilities"></video>';
    ...
    public function youtube_sc( $atts, $content = null ) {
        ...
        $width = '1000';
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="https://www.youtube.com/embed/' . esc_attr( $video_id ) . '?wmode=opaque&amp;controls=1&amp;showinfo=1&amp;autohide=1&amp;rel=0&amp;autoplay=' . $autoplay . '" width="' . esc_attr($width) . '" height="' . esc_attr($height) . '"></iframe></div>';
    ...
    public function vimeo_sc( $atts, $content = null ) {
        ...
        $width = '1000';
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="https://player.vimeo.com/video/' . esc_attr( $video_id ) . '?title=0&amp;byline=0&amp;portrait=0&amp;autohide=1&amp;color=' . esc_attr($color) . '&amp;autoplay=' . $autoplay . '" width="' . esc_attr($width) . '" height="' . esc_attr($height) . '"></iframe></div>';

    }

    /**
     * Screenr video shortcode [go_pricing_screenr]
     * Deprecated- Screenr.com is closed
     *
     * @return string Returns HTML code.
     */
    ...
    public function dailymotion_sc( $atts, $content = null ) {
        ...
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="//www.dailymotion.com/embed/video/' . esc_attr( $video_id ) . '?wmode=opaque&amp;autoPlay=' . $autoplay . '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
    ...
    public function metacafe_sc( $atts, $content = null ) {
        ...
        $autoplay = $autoplay == 'yes' ? '1' : '0';
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="http://www.metacafe.com/embed/' . esc_attr( $video_id ) . '?wmode=opaque&amp;ap=' . $autoplay . '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
    ...
    public function audio_sc( $atts, $content = null ) {
        ...
        $autoplay = $autoplay == 'yes' ? ' autoplay="true"' : '';
        $loop = $loop == 'yes' ? ' loop="true"' : '';
        $mp3_src = $mp3_src != '' ? '<source src="' . esc_attr($mp3_src) . '" type="audio/mpeg">' : '';
        $ogg_src = $ogg_src != '' ? '<source src="' . esc_attr($ogg_src) . '" type="audio/ogg">' : '';
        $wav_src = $wav_src != '' ? '<source src="' . esc_attr($wav_src) . '" type="audio/wav">' : '';
    ...
    public function soundcloud_sc( $atts, $content = null ) {
        ...
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="//w.soundcloud.com/player/?url=http%3A%2F%2Fapi.soundcloud.com%2Ftracks%2F' . esc_attr( $track_id ) . '?wmode=opaque&amp;auto_play=' . $autoplay . '&amp;show_artwork=true" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
    ...
    public function mixcloud_sc( $atts, $content = null ) {
        ...
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="//www.mixcloud.com/widget/iframe/?feed=' . esc_attr( urlencode( trim( $track_id, '/' ) ) ) . '%2F&amp;show_tracklist=&amp;wmode=opaque" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
    ...
    public function beatport_sc( $atts, $content = null ) {
        ...
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="http://embed.beatport.com/player?id=' . esc_attr( $track_id ) . '?wmode=opaque&amp;type=track' . $autoplay . '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
    ...
    public function goole_map_sc( $atts, $content = null ) {
        ...
        return '<div class="gw-go-gmap' . $class . '" style="width:100%; height:' . esc_attr($height) . 'px;" data-map="' . esc_attr( json_encode( $mapdata ) ) . '"></div>';
    ...
    public function iframe_sc( $atts, $content = null ) {
        ...
        $style = $height != 'auto' ? 'height:' . esc_attr($height) . 'px !important; padding:0 !important;' : '';
        return '<div class="gw-go-video-wrapper"' . ( $style != '' ? ' style="' . $style . '"' : '' ) . '><iframe src="' . esc_attr( $url ) . '?wmode=opaque" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>';
