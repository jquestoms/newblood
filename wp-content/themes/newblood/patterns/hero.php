...
<div class="wp-block-group nb-gradient-primary nb-dot-grid nb-hero-gradient">
  ...
  <p class="nb-label nb-hero-label">25+ years of craft</p>
  <!-- /wp:paragraph -->
  ...
  <p class="nb-hero-body has-text-secondary-color">For businesses that want a website made for them, and for established operators who need a platform that wins their territory. We pair decades of hands-on craft with modern AI workflows to build sites that are measured in every sense: more considered, more technically ambitious, and more memorable than the brief called for.</p>
  <!-- /wp:paragraph -->
