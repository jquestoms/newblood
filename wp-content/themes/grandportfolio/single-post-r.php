...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
			...
			<div id="post_share_text" class="post_share_text"><i class="fa fa-share-alt"></i><?php echo esc_html_e( 'Share', 'grandportfolio' ); ?></div>
			<hr/>
			<br class="clear"/><br/>
			...
			<div id="about_the_author">
			    ...
			    <div class="author_detail">
			     	<div class="author_content">
			     		<div class="author_label"><?php echo esc_html_e( 'Author', 'grandportfolio' ); ?></div>
			...
			if ($tags) {
			 ...
			 ?>
			  	<h6 class="subtitle"><span><?php echo esc_html_e('You might also like', 'grandportfolio' ); ?></span></h6><hr class="title_break"/>
