	    ...
	    <div class="post_content_wrapper">
					...
					<div class="post_quote_title">
					    ...
					    <div class="post_detail">
							...
							<span class="post_info_comment">
				    	    	<a href="<?php comments_link(); ?>"><?php comments_number(esc_html__('No Comment', 'grandportfolio'), esc_html__('1 Comment', 'grandportfolio'), esc_html__('% Comments', 'grandportfolio')); ?></a>
				        	</span>
						</div>
					</div>
			<?php
			...
			?>
			    ...
			    <div class="post_button_wrapper">
			    	<a class="readmore" href="<?php the_permalink(); ?>"><?php echo esc_html_e('Continue Reading', 'grandportfolio' ); ?></a>
			    	<span class="post_info_comment">
				        <a href="<?php comments_link(); ?>"><?php comments_number(esc_html__('No Comment', 'grandportfolio'), esc_html__('1 Comment', 'grandportfolio'), esc_html__('% Comments', 'grandportfolio')); ?></a>
				    </span>
			    </div>
