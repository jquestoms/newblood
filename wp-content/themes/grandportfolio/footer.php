...
<?php
	...
	if(!empty($pp_photostream))
	{
		...
		if($pp_photostream == 'flickr')
		{
			...
			$photos_arr = grandportfolio_get_flickr(array('type' => 'user', 'id' => $pp_flickr_id, 'items' => 24));
		}
		else
		{
			$pp_instagram_username = get_option('pp_instagram_username');
			$is_instagram_authorized = grandportfolio_check_instagram_authorization();
			
			if(is_bool($is_instagram_authorized) && $is_instagram_authorized)
			{
				$photos_arr = grandportfolio_get_instagram_using_plugin('photostream', 24);
			}
			else
			{
    	...
    	<?php
    		$customizer_styling_arr = array( 
				...
				array(
					'id'	=>	'demo1', 
					'title' => 'Architect', 
					'url' => 'https://themes.themegoods.com/grandportfolio/demo1'
				),
				array(
					'id'	=>	'demo2', 
					'title' => 'Blogger', 
				...
				array(
					'id'	=>	'demo6', 
					'title' => 'Photographer', 
					'url' => 'https://themes.themegoods.com/grandportfolio/demo6'
				),
				array(
					'id'	=>	'demo7', 
