	...
	<td>
	    ...
	    <div class="wp-caption aligncenter">
		    ...
		    <?php
		    	...
		    	{
		    ?>
		    <a href="<?php echo esc_url($grandportfolio_purchase_url); ?>" class="button ghost"><i class="fa fa-shopping-cart marginright"></i><?php esc_html_e('Purchase', 'grandportfolio' ); ?></a>
		    <?php
		    	}
		    ?>
	    </div>
