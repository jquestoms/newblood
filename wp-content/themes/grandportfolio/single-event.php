...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
	    ...
	    <div class="post_content_wrapper">
	    	...
	    	?>
	    	<div class="one_half">
	    		<h5 class="event_title"><?php esc_html_e('Detail', 'grandportfolio' ); ?></h5>
	    		<?php
				    the_content();
				?>
				<div class="post_button_wrapper textalignleft">
					<?php
						...
						{
					?>
					<a class="button buyticket" href="<?php echo esc_url($event_ticket_url[0]); ?>" target="_blank"><?php echo esc_html_e('Buy Ticket', 'grandportfolio' ); ?></a>
					<?php
						}
					?>
				</div>
		    	...
		    	<div class="post_header textalignleft">
				    <div class="post_header_title textalignleft">
				    	<?php
				    		...
				    		{
				    	?>
				    	<h5 class="event_title"><?php esc_html_e('Start Date', 'grandportfolio' ); ?></h5>
				    	<div class="ppb_subtitle event" style="">
				    		...
				    		<?php 
				    			if(!empty($event_from_time) OR !empty($event_to_time))
				    			{
				    				...
				    				if(!empty($event_to_time) && is_array($event_to_time))
				    				{
				    	...
				    	<?php
				    		...
				    		{
				    	?>
				    		<h5 class="event_title"><?php esc_html_e('Location', 'grandportfolio' ); ?></h5>
					    	...
					    	<br class="clear"/>
					    	<div class="post_button_wrapper textalignleft">
								<a class="readmore" target="_blank" href="https://maps.google.com?saddr=Current+Location&daddr=<?php echo urlencode($event_location); ?>"><?php echo esc_html_e('Get Directions', 'grandportfolio' ); ?> →</a>
							</div>
					    	<?php
					    		}
				    		}
