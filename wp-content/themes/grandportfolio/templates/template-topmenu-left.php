    	...
    	<div id="logo_normal" class="logo_container">
    		<div class="logo_align">
	    	    <a id="custom_logo" class="logo_wrapper <?php if(!empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>" href="<?php echo esc_url(home_url('/')); ?>">
					...
					?>
	    	    	<img src="<?php echo esc_url($tg_retina_logo); ?>" alt="<?php echo esc_attr($image_alt); ?>" width="<?php echo(esc_attr($image_width)); ?>" height="<?php echo(esc_attr($image_height)); ?>"/>
	    	    	<?php 
		    	    	}
		    	    ?>
	    	    </a>
	    	    ...
	    	    <a id="custom_logo_transparent" class="logo_wrapper <?php if(empty($page_menu_transparent)) { ?>hidden<?php } else { ?>default<?php } ?>" href="<?php echo esc_url(home_url('/')); ?>">
					...
					<?php
						...
						else
						{
							...
							$image_height = intval($image_height/2);
					?>
	    	    	<img src="<?php echo esc_url($tg_retina_transparent_logo); ?>" alt="<?php echo esc_attr($image_alt); ?>" width="<?php echo(esc_attr($image_width)); ?>" height="<?php echo(esc_attr($image_height)); ?>"/>
	    	    	<?php 
		    	    	}
		    	    ?>
	    	    </a>
	        		...
	        		<div id="menu_border_wrapper">
	        			<?php 	
	        				...
	        				if(empty($page_menu))
	    					{
	    		    			...
	    		    			{
	    			    			echo '<div class="notice">'.esc_html__('Setup Menu via Wordpress Dashboard > Appearance > Menus', 'grandportfolio' ).'</div>';
	    		    			}
	    	    			}
	    	    			else
	    				    {
		    	...
		    	<div id="logo_right_button">
			    	<div class="logo_right_button">
						...
						<div class="post_share_wrapper">
							<a id="page_share" class="tooltip" href="javascript:;" title="<?php esc_html_e('Share', 'grandportfolio' ); ?>"><i class="fa fa-share-alt"></i></a>
						</div>
						<?php
							$post_type = get_post_type();
						...
						<div class="post_download_wrapper">
							<a id="gallery_download" class="tooltip" href="<?php echo esc_url($gallery_download); ?>" title="<?php esc_html_e('Download', 'grandportfolio' ); ?>"><i class="fa fa-download"></i></a>
						</div>
						<?php	
								}
						...
						<div class="view_fullscreen_wrapper">
							<a class="tooltip" id="page_maximize" href="javascript:;" title="<?php esc_html_e('View Fullscreen', 'grandportfolio' ); ?>"><i class="fa fa-expand"></i></a>
							<a class="tooltip" id="page_minimize" href="javascript:;" title="<?php esc_html_e('Exit Fullscreen', 'grandportfolio' ); ?>"><i class="fa fa-compress"></i></a>
						</div>
						<?php
							}
						?>
						...
						<div class="header_cart_wrapper">
						    ...
						    <a class="tooltip" href="<?php echo esc_url($cart_url); ?>" title="<?php esc_html_e('View Cart', 'grandportfolio' ); ?>"><i class="fa fa-shopping-cart"></i></a>
						</div>
						<?php
						}
						?>
