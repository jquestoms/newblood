...
function grandportfolio_demo_configuration_sample() {
    ...
    $strings = array(
        'background-color' => esc_html__('Background Color', 'grandportfolio' ),
        'background-image' => esc_html__('Background Image', 'grandportfolio' ),
        'no-repeat' => esc_html__('No Repeat', 'grandportfolio' ),
        'repeat-all' => esc_html__('Repeat All', 'grandportfolio' ),
        'repeat-x' => esc_html__('Repeat Horizontally', 'grandportfolio' ),
        'repeat-y' => esc_html__('Repeat Vertically', 'grandportfolio' ),
        'inherit' => esc_html__('Inherit', 'grandportfolio' ),
        'background-repeat' => esc_html__('Background Repeat', 'grandportfolio' ),
        'cover' => esc_html__('Cover', 'grandportfolio' ),
        'contain' => esc_html__('Contain', 'grandportfolio' ),
        'background-size' => esc_html__('Background Size', 'grandportfolio' ),
        'fixed' => esc_html__('Fixed', 'grandportfolio' ),
        'scroll' => esc_html__('Scroll', 'grandportfolio' ),
        'background-attachment' => esc_html__('Background Attachment', 'grandportfolio' ),
        'left-top' => esc_html__('Left Top', 'grandportfolio' ),
        'left-center' => esc_html__('Left Center', 'grandportfolio' ),
        'left-bottom' => esc_html__('Left Bottom', 'grandportfolio' ),
        'right-top' => esc_html__('Right Top', 'grandportfolio' ),
        'right-center' => esc_html__('Right Center', 'grandportfolio' ),
        'right-bottom' => esc_html__('Right Bottom', 'grandportfolio' ),
        'center-top' => esc_html__('Center Top', 'grandportfolio' ),
        'center-center' => esc_html__('Center Center', 'grandportfolio' ),
        'center-bottom' => esc_html__('Center Bottom', 'grandportfolio' ),
        'background-position' => esc_html__('Background Position', 'grandportfolio' ),
        'background-opacity' => esc_html__('Background Opacity', 'grandportfolio' ),
        'ON' => esc_html__('ON', 'grandportfolio' ),
        'OFF' => esc_html__('OFF', 'grandportfolio' ),
        'all' => esc_html__('All', 'grandportfolio' ),
        'cyrillic' => esc_html__('Cyrillic', 'grandportfolio' ),
        'cyrillic-ext' => esc_html__('Cyrillic Extended', 'grandportfolio' ),
        'devanagari' => esc_html__('Devanagari', 'grandportfolio' ),
        'greek' => esc_html__('Greek', 'grandportfolio' ),
        'greek-ext' => esc_html__('Greek Extended', 'grandportfolio' ),
        'khmer' => esc_html__('Khmer', 'grandportfolio' ),
        'latin' => esc_html__('Latin', 'grandportfolio' ),
        'latin-ext' => esc_html__('Latin Extended', 'grandportfolio' ),
        'vietnamese' => esc_html__('Vietnamese', 'grandportfolio' ),
    );

    $args = array(
        'textdomain'   => 'grandportfolio',
    );
...
function grandportfolio_add_panels_and_sections( $wp_customize ) {
    ...
    $wp_customize->add_panel( 'general', array(
        'priority'    => 35,
        'title'       => esc_html__('General', 'grandportfolio' ),
    ) ); 
    
    $wp_customize->add_panel( 'menu', array(
        'priority'    => 35,
        'title'       => esc_html__('Navigation', 'grandportfolio' ),
    ) );
    
    $wp_customize->add_panel( 'header', array(
        'priority'    => 39,
        'title'       => esc_html__('Header', 'grandportfolio' ),
    ) );
    
    $wp_customize->add_panel( 'sidebar', array(
        'priority'    => 43,
        'title'       => esc_html__('Sidebar', 'grandportfolio' ),
    ) );
    
    $wp_customize->add_panel( 'footer', array(
        'priority'    => 44,
        'title'       => esc_html__('Footer', 'grandportfolio' ),
    ) );
    
    $wp_customize->add_panel( 'gallery', array(
        'priority'    => 45,
        'title'       => esc_html__('Gallery', 'grandportfolio' ),
    ) );
    
    $wp_customize->add_panel( 'portfolio', array(
        'priority'    => 46,
        'title'       => esc_html__('Portfolio', 'grandportfolio' ),
    ) );
    
    $wp_customize->add_panel( 'blog', array(
        'priority'    => 47,
        'title'       => esc_html__('Blog', 'grandportfolio' ),
    ) );
	...
	if(class_exists('Woocommerce'))
	{
		$wp_customize->add_panel( 'shop', array(
	        'priority'    => 48,
	        'title'       => esc_html__('Shop', 'grandportfolio' ),
	    ) );
	}
	...
	$wp_customize->add_section( 'logo_favicon', array(
        'title'       => esc_html__('Logo & Favicon', 'grandportfolio' ),
        'priority'    => 34,

    ) );
    
    $wp_customize->add_section( 'general_image', array(
        'title'       => esc_html__('Image', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 46,
    ...
    $wp_customize->add_section( 'general_typography', array(
        'title'       => esc_html__('Typography', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 47,
    ...
    $wp_customize->add_section( 'general_color', array(
        'title'       => esc_html__('Background & Colors', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 48,
    ...
    $wp_customize->add_section( 'general_input', array(
        'title'       => esc_html__('Input and Button Elements', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 49,
    ...
    $wp_customize->add_section( 'general_sharing', array(
        'title'       => esc_html__('Sharing', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 50,
    ...
    $wp_customize->add_section( 'general_mobile', array(
        'title'       => esc_html__('Mobile', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 50,
    ...
    $wp_customize->add_section( 'general_frame', array(
        'title'       => esc_html__('Frame', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 51,
    ...
    $wp_customize->add_section( 'general_boxed', array(
        'title'       => esc_html__('Boxed Layout', 'grandportfolio' ),
        'panel'		  => 'general',
        'priority'    => 52,
    ...
    $wp_customize->add_section( 'menu_color', array(
        'title'       => esc_html__('Colors', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 37,
    ...
    $wp_customize->add_section( 'menu_background', array(
        'title'       => esc_html__('Background', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 38,
    ...
    $wp_customize->add_section( 'menu_submenu', array(
        'title'       => esc_html__('Sub Menu', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 38,
    ...
    $wp_customize->add_section( 'menu_megamenu', array(
        'title'       => esc_html__('Mega Menu', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 38,
    ...
    $wp_customize->add_section( 'menu_topbar', array(
        'title'       => esc_html__('Top Bar', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 38,
    ...
    $wp_customize->add_section( 'menu_contact', array(
        'title'       => esc_html__('Contact Info', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 39,
    ...
    $wp_customize->add_section( 'menu_sidemenu', array(
        'title'       => esc_html__('Side Menu', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 39,
    ...
    $wp_customize->add_section( 'menu_search', array(
        'title'       => esc_html__('Side Menu Search', 'grandportfolio' ),
        'panel'		  => 'menu',
        'priority'    => 40,
    ...
    $wp_customize->add_section( 'header_title', array(
        'title'       => esc_html__('Page Title', 'grandportfolio' ),
        'panel'		  => 'header',
        'priority'    => 41,
    ...
    $wp_customize->add_section( 'header_title_bg', array(
        'title'       => esc_html__('Page Title With Background Image', 'grandportfolio' ),
        'panel'		  => 'header',
        'priority'    => 41,
    ...
    $wp_customize->add_section( 'header_builder_title', array(
        'title'       => esc_html__('Content Builder Header', 'grandportfolio' ),
        'panel'		  => 'header',
        'priority'    => 41,
    ...
    $wp_customize->add_section( 'header_tagline', array(
        'title'       => esc_html__('Page Tagline & Sub Title', 'grandportfolio' ),
        'panel'		  => 'header',
        'priority'    => 42,
    ...
    $wp_customize->add_section( 'footer_copyright', array(
        'title'       => esc_html__('Copyright', 'grandportfolio' ),
        'panel'		  => 'footer',
        'priority'    => 47,
    ...
    $wp_customize->add_section( 'gallery_sorting', array(
        'title'       => esc_html__('Images Sorting', 'grandportfolio' ),
        'panel'		  => 'gallery',
        'priority'    => 48,
    ...
    $wp_customize->add_section( 'gallery_lightbox', array(
        'title'       => esc_html__('Lightbox', 'grandportfolio' ),
        'panel'		  => 'gallery',
        'priority'    => 49,
    ...
    $wp_customize->add_section( 'gallery_archive', array(
        'title'       => esc_html__('Archive', 'grandportfolio' ),
        'panel'		  => 'gallery',
        'priority'    => 49,
    ...
    $wp_customize->add_section( 'gallery_fullscreen', array(
        'title'       => esc_html__('Fullscreen', 'grandportfolio' ),
        'panel'		  => 'gallery',
        'priority'    => 49,
    ...
    $wp_customize->add_section( 'gallery_kenburns', array(
        'title'       => esc_html__('Kenburns', 'grandportfolio' ),
        'panel'		  => 'gallery',
        'priority'    => 50,
    ...
    $wp_customize->add_section( 'gallery_flow', array(
        'title'       => esc_html__('Flow', 'grandportfolio' ),
        'panel'		  => 'gallery',
        'priority'    => 51,
    ...
    $wp_customize->add_section( 'portfolio_filterable', array(
        'title'       => esc_html__('Filterable', 'grandportfolio' ),
        'panel'		  => 'portfolio',
        'priority'    => 50,
    ...
    $wp_customize->add_section( 'portfolio_page', array(
        'title'       => esc_html__('Page Options', 'grandportfolio' ),
        'panel'		  => 'portfolio',
        'priority'    => 51,
    ...
    $wp_customize->add_section( 'portfolio_single', array(
        'title'       => esc_html__('Single Portfolio Page', 'grandportfolio' ),
        'panel'		  => 'portfolio',
        'priority'    => 52,
    ...
    $wp_customize->add_section( 'blog_slider', array(
        'title'       => esc_html__('Slider', 'grandportfolio' ),
        'panel'		  => 'blog',
        'priority'    => 54,
    ...
    $wp_customize->add_section( 'blog_single', array(
        'title'       => esc_html__('Single Post', 'grandportfolio' ),
        'panel'		  => 'blog',
        'priority'    => 55,
	...
	if(class_exists('Woocommerce'))
	{
		$wp_customize->add_section( 'shop_layout', array(
	        'title'       => esc_html__('Layout', 'grandportfolio' ),
	        'panel'		  => 'shop',
	        'priority'    => 55,
	    ...
	    $wp_customize->add_section( 'shop_single', array(
	        'title'       => esc_html__('Single Product', 'grandportfolio' ),
	        'panel'		  => 'shop',
	        'priority'    => 56,
...
function grandportfolio_custom_setting( $controls ) {
	...
	$controls[] = array(
        ...
        'label'    => esc_html__('Retina Logo', 'grandportfolio' ),
        'description' => esc_html__('Retina Ready Image logo. It should be 2x size of normal logo. For example 200x60px logo will displays at 100x30px', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Retina Transparent Logo', 'grandportfolio' ),
        'description' => esc_html__('Retina Ready Image logo for menu transparent page. It should be 2x size of normal logo. For example 200x60px logo will displays at 100x30px. Recommend logo color is white or bright color', 'grandportfolio' ),
        'section'  => 'logo_favicon',
    ...
    $controls[] = array(
        'type'     => 'image',
        'settings'  => 'tg_retina_fullscreen_menu_logo',
        'label'    => esc_html__('Retina Fullscreen Menu Logo', 'grandportfolio' ),
        'description' => esc_html__('Retina Ready Image logo for fullscreen menu layout. It should be 2x size of normal logo. For example 200x60px logo will displays at 100x30px. Recommend logo color is white or bright color', 'grandportfolio' ),
        'section'  => 'logo_favicon',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Right Click Protection', 'grandportfolio' ),
        'description' => esc_html__('Check this to disable right click.', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Image Dragging Protection', 'grandportfolio' ),
        'description' => esc_html__('Check this to disable dragging on all images.', 'grandportfolio' ),
        'section'  => 'general_image',
        'default'  => '',
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Kenburns Effect For Gallery and Portfolio Pages', 'grandportfolio' ),
        'description' => esc_html__('Check this to enable kenburns effect when mouse over gallery and portfolio images.', 'grandportfolio' ),
        'section'  => 'general_image',
        'default'  => 1,
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Main Content Font Family', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Main Content Font Size', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 15,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Font Family', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 'Karla',
        'choices'  => Kirki_Fonts::get_font_choices(),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Font Weight', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 400,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Font Spacing', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 0,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Text Transform', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 'none',
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_h1_size',
        'label'    => esc_html__('H1 Font Size', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 34,
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_h2_size',
        'label'    => esc_html__('H2 Font Size', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 30,
        'choices' => array( 'min' => 13, 'max' => 60, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_h3_size',
        'label'    => esc_html__('H3 Font Size', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 26,
        'choices' => array( 'min' => 13, 'max' => 60, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_h4_size',
        'label'    => esc_html__('H4 Font Size', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 22,
        'choices' => array( 'min' => 13, 'max' => 60, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_h5_size',
        'label'    => esc_html__('H5 Font Size', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 18,
        'choices' => array( 'min' => 13, 'max' => 60, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_h6_size',
        'label'    => esc_html__('H6 Font Size', 'grandportfolio' ),
        'section'  => 'general_typography',
        'default'  => 16,
        'choices' => array( 'min' => 13, 'max' => 60, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Main Content Background Color', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Content Font Color', 'grandportfolio' ),
        'section'  => 'general_color',
        'default'  => '#777777',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Content Link Color', 'grandportfolio' ),
        'section'  => 'general_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Content Hover Link Color', 'grandportfolio' ),
        'section'  => 'general_color',
        'default'  => '#999999',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('H1, H2, H3, H4, H5, H6 Font Color', 'grandportfolio' ),
        'section'  => 'general_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Horizontal Line Color', 'grandportfolio' ),
        'section'  => 'general_color',
        'default'  => '#e1e1e1',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Input and Textarea Background Color', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Input and Textarea Font Color', 'grandportfolio' ),
        'section'  => 'general_input',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Input and Textarea Border Color', 'grandportfolio' ),
        'section'  => 'general_input',
        'default'  => '#e1e1e1',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Input and Textarea Focus State Color', 'grandportfolio' ),
        'section'  => 'general_input',
        'default'  => '#999999',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Font Family', 'grandportfolio' ),
        'section'  => 'general_input',
        'default'  => 'Varela Round',
        'choices'  => Kirki_Fonts::get_font_choices(),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Background Color', 'grandportfolio' ),
        'section'  => 'general_input',
        'default'  => '#959595',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Font Color', 'grandportfolio' ),
        'section'  => 'general_input',
        'default'  => '#ffffff',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Button Border Color', 'grandportfolio' ),
        'section'  => 'general_input',
        'default'  => '#959595',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Responsive Layout', 'grandportfolio' ),
        'description' => esc_html__('Check this to enable responsive layout for tablet and mobile devices.', 'grandportfolio' ),
    ...
    $controls[] = array(
        'type'     => 'toggle',
        'settings'  => 'tg_frame',
        'label'    => esc_html__('Enable Frame', 'grandportfolio' ),
        'description' => esc_html__('Check this to enable frame for site layout', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Frame Color', 'grandportfolio' ),
        'section'  => 'general_frame',
        'default'  => '#ffffff',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'toggle',
        'settings'  => 'tg_boxed',
        'label'    => esc_html__('Enable Boxed Layout', 'grandportfolio' ),
        'description' => esc_html__('Check this to enable boxed layout for site layout', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Layout', 'grandportfolio' ),
	...
	$controls[] = array(
        ...
        'label'    => esc_html__('Enable Sticky Menu', 'grandportfolio' ),
        'description' => esc_html__('Enable this to display main menu fixed when scrolling.', 'grandportfolio' ),
        'section'  => 'menu_general',
        'default'  => 1,
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        'type'     => 'toggle',
        'settings'  => 'tg_fixed_menu_border',
        'label'    => esc_html__('Enable Sticky Menu Border', 'grandportfolio' ),
        'description' => esc_html__('Enable this to display sticky menu border.', 'grandportfolio' ),
        'section'  => 'menu_general',
        'default'  => 1,
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sticky Menu Color Scheme', 'grandportfolio' ),
        'section'  => 'menu_general',
        'default'  => 'light',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Font Family', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Font Size', 'grandportfolio' ),
        'section'  => 'menu_typography',
        'default'  => 14,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Padding', 'grandportfolio' ),
        'section'  => 'menu_typography',
        'default'  => 22,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Font Weight', 'grandportfolio' ),
        'section'  => 'menu_typography',
        'default'  => 600,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Font Spacing', 'grandportfolio' ),
        'section'  => 'menu_typography',
        'default'  => 0,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Font Text Transform', 'grandportfolio' ),
        'section'  => 'menu_typography',
        'default'  => 'none',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Font Color', 'grandportfolio' ),
        'section'  => 'menu_color',
        'default'  => '#666666',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Hover State Font Color', 'grandportfolio' ),
        'section'  => 'menu_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Active State Font Color', 'grandportfolio' ),
        'section'  => 'menu_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Bar Border Color', 'grandportfolio' ),
        'section'  => 'menu_color',
        'default'  => '#e1e1e1',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Menu Background', 'grandportfolio' ),
        'section'  => 'menu_color',
	    'default'     => '#ffffff',
	    'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_transparent_menu_opacity',
        'label'    => esc_html__('Transparent Menu Opacity', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('SubMenu Font Size', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('SubMenu Font Weight', 'grandportfolio' ),
        'section'  => 'menu_submenu',
        'default'  => 600,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('SubMenu Font Spacing', 'grandportfolio' ),
        'section'  => 'menu_submenu',
        'default'  => 0,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sub Menu Font Color', 'grandportfolio' ),
        'section'  => 'menu_submenu',
        'default'  => '#777777',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sub Menu Hover State Font Color', 'grandportfolio' ),
        'section'  => 'menu_submenu',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sub Menu Hover State Background Color', 'grandportfolio' ),
        'section'  => 'menu_submenu',
        'default'  => '#f9f9f9',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sub Menu Background Color', 'grandportfolio' ),
        'section'  => 'menu_submenu',
        'default'  => '#f9f9f9',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sub Menu Border Color', 'grandportfolio' ),
        'section'  => 'menu_submenu',
        'default'  => '#e1e1e1',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Mega Menu Header Font Color', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Mega Menu Border Color', 'grandportfolio' ),
        'section'  => 'menu_megamenu',
        'default'  => '#e1e1e1',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'toggle',
        'settings'  => 'tg_topbar',
        'label'    => esc_html__('Display Top Bar', 'grandportfolio' ),
        'description' => esc_html__('Enable this option to display top bar above main menu', 'grandportfolio' ),
        'section'  => 'menu_topbar',
        'default'  => 0,
	    'priority' => 21,
    );
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_topbar_content',
        'label'    => esc_html__('Topbar Content', 'grandportfolio' ),
        'section'  => 'menu_topbar',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Top Bar Background Color', 'grandportfolio' ),
        'section'  => 'menu_topbar',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Top Bar Menu Font Color', 'grandportfolio' ),
        'section'  => 'menu_topbar',
        'default'  => '#ffffff',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_topbar_font',
        'label'    => esc_html__('Top Bar Font Family', 'grandportfolio' ),
        'section'  => 'menu_topbar',
        'default'  => 'Karla',
        'choices'  => Kirki_Fonts::get_font_choices(),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_topbar_font_weight',
        'label'    => esc_html__('Top Bar Font Weight', 'grandportfolio' ),
        'section'  => 'menu_topbar',
        'default'  => 400,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Contact Hours (Optional)', 'grandportfolio' ),
        'description' => esc_html__('Enter your company contact hours.', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Contact Phone Number (Optional)', 'grandportfolio' ),
        'description' => esc_html__('Enter your company contact phone number.', 'grandportfolio' ),
        'section'  => 'menu_contact',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Open Top Bar Social Icons link in new window', 'grandportfolio' ),
        'description' => esc_html__('Check this to open top bar social icons link in new window', 'grandportfolio' ),
        'section'  => 'menu_contact',
        'default'  => 1,
	    'priority' => 28,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Search', 'grandportfolio' ),
        'description' => esc_html__('Select to display search form in header of side menu', 'grandportfolio' ),
        'section'  => 'menu_search',
        'default'  => 1,
	    'priority' => 28,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Instant Search', 'grandportfolio' ),
        'description' => esc_html__('Select to display search result instantly while typing', 'grandportfolio' ),
        'section'  => 'menu_search',
        'default'  => 1,
	    'priority' => 29,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Search Input Background Color', 'grandportfolio' ),
        'section'  => 'menu_search',
        'default'  => '#ffffff',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Search Input Font Color', 'grandportfolio' ),
        'section'  => 'menu_search',
        'default'  => '#777777',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_sidemenu_layout',
        'label'    => esc_html__('Side Menu Layout', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Side Menu on Desktop', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Background', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
	    'default'     => '#ffffff',
	    'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Font Family', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => 'Karla',
        'choices'  => Kirki_Fonts::get_font_choices(),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Font Size', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => 16,
        'choices' => array( 'min' => 11, 'max' => 40, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Font Line Height (in em)', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => 3,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Font Weight', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => 400,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Font Text Transform', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => 'none',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Font Spacing', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => 0,
        'choices' => array( 'min' => -2, 'max' => 5, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Font Color', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => '#777777',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Side Menu Hover State Font Color', 'grandportfolio' ),
        'section'  => 'menu_sidemenu',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Add Blur Effect When Scroll', 'grandportfolio' ),
        'description' => esc_html__('Enable this option to add blur effect to header background image when scrolling pass it', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Header Background Color', 'grandportfolio' ),
        'section'  => 'header_background',
        'default'  => '#f9f9f9',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_page_header_alignment',
        'label'    => esc_html__('Page Header Alignment', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Header Padding Top', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => 30,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Header Padding Bottom', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => 40,
        'choices' => array( 'min' => 0, 'max' => 200, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Font Size', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => 32,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Font Weight', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => 400,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Font Line Height (in em)', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => 1.4,
        'choices' => array( 'min' => 1, 'max' => 4, 'step' => 0.2 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Text Transform', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => 'none',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Font Spacing', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => 0,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Font Color', 'grandportfolio' ),
        'section'  => 'header_title',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Title Background Image Height (in %)', 'grandportfolio' ),
        'section'  => 'header_title_bg',
        'default'  => 70,
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_page_title_bg_bg_style',
        'label'    => esc_html__('Header With Background Style', 'grandportfolio' ),
        'section'  => 'header_title_bg',
        'default'  => 'classic',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__(' Content Builder Header Font Size', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Content Builder Header Text Transform', 'grandportfolio' ),
        'section'  => 'header_builder_title',
        'default'  => 'none',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_subtitle_builder_font_size',
        'label'    => esc_html__(' Content Builder Sub Title Font Size', 'grandportfolio' ),
        'section'  => 'header_builder_title',
        'default'  => 11,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Tagline Font Color', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Tagline Font Weight', 'grandportfolio' ),
        'section'  => 'header_tagline',
        'default'  => 400,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Tagline Font Spacing', 'grandportfolio' ),
        'section'  => 'header_tagline',
        'default'  => 0,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Page Tagline Text Transform', 'grandportfolio' ),
        'section'  => 'header_tagline',
        'default'  => 'none',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Widget Title Font Family', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Widget Title Font Size', 'grandportfolio' ),
        'section'  => 'sidebar_typography',
        'default'  => 12,
        'choices' => array( 'min' => 11, 'max' => 40, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Widget Title Font Weight', 'grandportfolio' ),
        'section'  => 'sidebar_typography',
        'default'  => 900,
        'choices' => array( 'min' => 100, 'max' => 900, 'step' => 100 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Widget Title Font Spacing', 'grandportfolio' ),
        'section'  => 'sidebar_typography',
        'default'  => 2,
        'choices' => array( 'min' => -2, 'max' => 4, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Widget Title Text Transform', 'grandportfolio' ),
        'section'  => 'sidebar_typography',
        'default'  => 'uppercase',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sidebar Font Color', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sidebar Link Color', 'grandportfolio' ),
        'section'  => 'sidebar_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sidebar Hover Link Color', 'grandportfolio' ),
        'section'  => 'sidebar_color',
        'default'  => '#999999',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Sidebar Widget Title Font Color', 'grandportfolio' ),
        'section'  => 'sidebar_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Sidebar Columns', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Open Footer Social Icons link in new window', 'grandportfolio' ),
        'description' => esc_html__('Check this to open footer social icons link in new window', 'grandportfolio' ),
        'section'  => 'footer_general',
        'default'  => 1,
	    'priority' => 3,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Background', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Font Color', 'grandportfolio' ),
        'section'  => 'footer_color',
        'default'  => '#777777',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Link Color', 'grandportfolio' ),
        'section'  => 'footer_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Hover Link Color', 'grandportfolio' ),
        'section'  => 'footer_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Border Color', 'grandportfolio' ),
        'section'  => 'footer_color',
        'default'  => '#e1e1e1',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Social Icon Color', 'grandportfolio' ),
        'section'  => 'footer_color',
        'default'  => '#999999',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Footer Widget Title Color', 'grandportfolio' ),
        'section'  => 'footer_color',
        'default'  => '#222222',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_footer_copyright_layout',
        'label'    => esc_html__('Copyright Content Layout', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Copyright Text', 'grandportfolio' ),
        'description' => esc_html__('Enter your copyright text.', 'grandportfolio' ),
        'section'  => 'footer_copyright',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Copyright Additional Content', 'grandportfolio' ),
        'section'  => 'footer_copyright',
        'default'  => 'social',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Go To Top Button', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Gallery Images Sorting', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Select lightbox skin color', 'grandportfolio' ),
        'description' => esc_html__('Select which skin you want to use for lightbox', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display image caption in lightbox', 'grandportfolio' ),
        'description' => esc_html__('Check if you want to display image caption under the image in lightbox mode', 'grandportfolio' ),
        'section'  => 'gallery_lightbox',
        'default'  => 1,
	    'priority' => 2,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Select lightbox thumbnails alignment', 'grandportfolio' ),
        'description' => esc_html__('Select which alignment you want to use for lightbox thumbnails', 'grandportfolio' ),
        'section'  => 'gallery_lightbox',
        'default'  => 'horizontal',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Lightbox Overlay Opacity', 'grandportfolio' ),
        'section'  => 'gallery_lightbox',
        'default'  => 95,
        'choices' => array( 'min' => 0, 'max' => 100, 'step' => 5 ),
	    'priority' => 1,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable slideshow on hover effect', 'grandportfolio' ),
        'description' => esc_html__('Check this option to enable slideshow effect when move mouse over gallery thumbnail', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable autoplay slideshow', 'grandportfolio' ),
        'description' => esc_html__('Check this option to let fullscreen slideshow starts playing automatically', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable random slideshow', 'grandportfolio' ),
        'description' => esc_html__('Check this option to let fullscreen slideshow displays images randomly', 'grandportfolio' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 0,
	    'priority' => 4,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Slideshow Timer', 'grandportfolio' ),
        'description' => esc_html__('Select number of seconds for Full Screen Slideshow timer', 'grandportfolio' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 9,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Slideshow Transition Effect', 'grandportfolio' ),
        'description' => esc_html__('Select transition type for contents in Full Screen slideshow', 'grandportfolio' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 1,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Slideshow Transition Timer', 'grandportfolio' ),
        'description' => esc_html__('Select number of milliseconds for transition between each image', 'grandportfolio' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 800,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display slideshow image caption', 'grandportfolio' ),
        'description' => esc_html__('Check this option if you want to display fullscreen slideshow image caption', 'grandportfolio' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 1,
	    'priority' => 7,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display image proportion size', 'grandportfolio' ),
        'description' => esc_html__('Check this option if you want to display slide image proportion size without covering screen', 'grandportfolio' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 0,
	    'priority' => 8,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display slideshow arrows', 'grandportfolio' ),
        'description' => esc_html__('Check this option if you want to display slide navigation arrow', 'grandportfolio' ),
        'section'  => 'gallery_fullscreen',
        'default'  => 0,
	    'priority' => 8,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Kenburns Slideshow timer', 'grandportfolio' ),
        'description' => esc_html__('Select number of seconds for Kenburns Slideshow timer', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Kenburns Zoom Level', 'grandportfolio' ),
        'description' => esc_html__('Select zoom level for Kenburns slideshow', 'grandportfolio' ),
        'section'  => 'gallery_kenburns',
        'default'  => 2,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Kenburns Transition Timer', 'grandportfolio' ),
        'description' => esc_html__('Select number of seconds for transition between each image', 'grandportfolio' ),
        'section'  => 'gallery_kenburns',
        'default'  => 1000,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Image Reflection', 'grandportfolio' ),
        'description' => esc_html__('Check this option if you want to display mirror reflection effect in flow gallery', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Link flow gallery image to lightbox', 'grandportfolio' ),
        'description' => esc_html__('Check this option if you want to link flow gallery to full size image in lightbox mode', 'grandportfolio' ),
        'section'  => 'gallery_flow',
        'default'  => 1,
	    'priority' => 12,
    );
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_portfolio_hover_style',
        'label'    => esc_html__('Portfolio Hover Style', 'grandportfolio' ),
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_portfolio_hover_timer',
        'label'    => esc_html__('Portfolio Hover Timer', 'grandportfolio' ),
        'description' => esc_html__('Select number of seconds for transition when hover portfolio image', 'grandportfolio' ),
        'section'  => 'portfolio_general',
        'default'  => 4.5,
    ...
    $controls[] = array(
        'type'     => 'toggle',
        'settings'  => 'tg_portfolio_grayscale',
        'label'    => esc_html__('Enable Portfolio Grayscale Filter', 'grandportfolio' ),
        'description' => esc_html__('Check this option to enable grayscale filter for portfolio featured images', 'grandportfolio' ),
        'section'  => 'portfolio_general',
        'default'  => 0,
	    'priority' => 3,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Enable Portfolio Filterable Feature', 'grandportfolio' ),
        'description' => esc_html__('Check this option to enable filterable feature in portfolio pages', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Link Portfolio Filterable', 'grandportfolio' ),
        'description' => esc_html__('Check this option to enable linking filterable to its page.', 'grandportfolio' ),
        'section'  => 'portfolio_filterable',
        'default'  => 0,
	    'priority' => 1,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Filterable Options Sorting', 'grandportfolio' ),
        'section'  => 'portfolio_filterable',
        'default'  => 'name',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Page Show At Most', 'grandportfolio' ),
        'description' => esc_html__('Select number of portfolio items you want to display per page', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Portfolio Page (Optional)', 'grandportfolio' ),
        'description' => esc_html__('Enter your portfolio page URL so it displays portfolio page link in recent portfolio module.', 'grandportfolio' ),
        'section'  => 'portfolio_page',
        'default'  => '',
	    'priority' => 7,
    );
    ...
    $controls[] = array(
        'type'     => 'toggle',
        'settings'  => 'tg_portfolio_fullscreen_menu_recent',
        'label'    => esc_html__('Display Recent Portfolios on Fullscreen Menu Layout (Optional)', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display recent portfolios when using fullscreen menu layout', 'grandportfolio' ),
        'section'  => 'portfolio_page',
        'default'  => 1,
	    'priority' => 8,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Next and Previous Portfolios', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display next and previous portfolios in single portfolio page', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Recent Portfolios', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display recent portfolios in single portfolio page', 'grandportfolio' ),
        'section'  => 'portfolio_single',
        'default'  => 1,
	    'priority' => 6,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Full Blog Post Content', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display post full content in blog page (excerpt blog grid layout)', 'grandportfolio' ),
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Archive Page Layout', 'grandportfolio' ),
        'description' => esc_html__('Select page layout for displaying archive page', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 'blog_f',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Category Page Layout', 'grandportfolio' ),
        'description' => esc_html__('Select page layout for displaying category page', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 'blog_f',
        'choices'  => $tg_blog_layout,
	    'priority' => 2,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Tag Page Layout', 'grandportfolio' ),
        'description' => esc_html__('Select page layout for displaying tag page', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 'blog_f',
        'choices'  => $tg_blog_layout,
	    'priority' => 3,
     ...
     $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_blog_fullwidth',
        'label'    => esc_html__('Blog Fullwidth Layout Custom Width (in %)', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 80,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Post Category Link Font Color', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => '#999999',
        'output' => array(
	        array(
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_blog_header_align',
        'label'    => esc_html__('Post Header Text Alignment', 'grandportfolio' ),
        'description' => esc_html__('Select text alignment for post header', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 'center',
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_blog_header_transform',
        'label'    => esc_html__('Post Header Text Transform', 'grandportfolio' ),
        'description' => esc_html__('Select text transform for post header', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 'none',
        'choices'  => $tg_text_transform,
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_blog_classic_title_font_size',
        'label'    => esc_html__(' Blog Classic Title Font Size', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 32,
        'choices' => array( 'min' => 12, 'max' => 100, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_blog_fullwidth_title_font_size',
        'label'    => esc_html__(' Blog Fullwidth Title Font Size', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 32,
        'choices' => array( 'min' => 12, 'max' => 100, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_blog_twocols_title_font_size',
        'label'    => esc_html__(' Blog Grid 2 Columns Title Font Size', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 22,
        'choices' => array( 'min' => 12, 'max' => 100, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_blog_threecols_title_font_size',
        'label'    => esc_html__(' Blog Grid 3 Columns Title Font Size', 'grandportfolio' ),
        'section'  => 'blog_general',
        'default'  => 20,
        'choices' => array( 'min' => 12, 'max' => 100, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Slider', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display slider in blog pages', 'grandportfolio' ),
        'section'  => 'blog_slider',
        'default'  => 1,
	    'priority' => 3,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Slider Layout', 'grandportfolio' ),
        'description' => esc_html__('Select layout for slider posts', 'grandportfolio' ),
        'section'  => 'blog_slider',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Slider Post Category', 'grandportfolio' ),
        'description' => esc_html__('Select post category filter for slider posts', 'grandportfolio' ),
        'section'  => 'blog_slider',
        'default'  => '',
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Slider Post Items', 'grandportfolio' ),
        'section'  => 'blog_slider',
        'default'  => 5,
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_single_post_title_size',
        'label'    => esc_html__('Single Post Title Font Size', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 34,
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_single_post_sub_title_size',
        'label'    => esc_html__('Single Post Sub Title Font Size', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 26,
        'choices' => array( 'min' => 13, 'max' => 80, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'slider',
        'settings'  => 'tg_single_post_related_title_size',
        'label'    => esc_html__('Single Post Related Title Font Size', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 15,
        'choices' => array( 'min' => 13, 'max' => 80, 'step' => 1 ),
        'output' => array(
    ...
    $controls[] = array(
        'type'     => 'select',
        'settings'  => 'tg_single_post_bg_style',
        'label'    => esc_html__('Header With Background Style', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 'classic',
        'choices'  => $tg_header_bg_style,
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Post Header', 'grandportfolio' ),
        'description' => esc_html__('Check this to display featured image as post header background', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 1,
	    'priority' => 4,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Post Featured Content', 'grandportfolio' ),
        'description' => esc_html__('Check this to display featured content (image or gallery) in single post page', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 0,
	    'priority' => 5,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Post Tags', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display post tags on single post page', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 1,
	    'priority' => 6,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display About Author', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display about author on single post page', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 1,
	    'priority' => 7,
    );
    ...
    $controls[] = array(
        ...
        'label'    => esc_html__('Display Related Posts', 'grandportfolio' ),
        'description' => esc_html__('Check this option to display related posts on single post page', 'grandportfolio' ),
        'section'  => 'blog_single',
        'default'  => 1,
	    'priority' => 8,
    );
	...
	if(class_exists('Woocommerce'))
	{
		...
		$controls[] = array(
	        ...
	        'label'    => esc_html__('Shop Main Page Layout', 'grandportfolio' ),
	        'description' => esc_html__('Select page layout for displaying shop\'s products page', 'grandportfolio' ),
	        'section'  => 'shop_layout',
	        'default'  => 'fullwidth',
	    ...
	    $controls[] = array(
	        ...
	        'label'    => esc_html__('Products Page Show At Most', 'grandportfolio' ),
	        'description' => esc_html__('Select number of product items you want to display per page', 'grandportfolio' ),
	        'section'  => 'shop_layout',
	        'default'  => 16,
	    ...
	    $controls[] = array(
	        ...
	        'label'    => esc_html__('Product Price Font Color', 'grandportfolio' ),
	        'section'  => 'shop_single',
	        'default'  => '#222222',
	        'output' => array(
		        array(
	    ...
	    $controls[] = array(
	        ...
	        'label'    => esc_html__('Display Related Products', 'grandportfolio' ),
	        'description' => esc_html__('Check this option to display related products on single product page', 'grandportfolio' ),
	        'section'  => 'shop_single',
	        'default'  => 1,
		    'priority' => 3,
	    );
