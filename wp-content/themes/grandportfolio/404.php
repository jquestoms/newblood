...
<div id="page_caption">
	<div class="page_title_wrapper <?php echo esc_attr($tg_page_header_alignment); ?>">
		<div class="page_title_inner">
		    <h1><?php esc_html_e('Error 404 Page', 'grandportfolio' ); ?></h1>
		    <div class="page_tagline">
				<?php esc_html_e('This page could not be found', 'grandportfolio' ); ?>
			</div>
		</div>
	</div>
</div>
...
<div id="page_content_wrapper">
    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
	    	...
	    	<h5><?php esc_html_e('Or try to browse our latest posts instead?', 'grandportfolio' ); ?></h5><br/>
