    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
    			...
    			<div class="search_form_wrapper">
	    			<?php esc_html_e( "If you didn't find what you were looking for, try a new search.", 'grandportfolio' ); ?><br/><br/>
	    			
	    			<form class="searchform" method="get" action="<?php echo esc_url(home_url('/')); ?>">
						<input style="width:100%" type="text" class="field searchform-s" name="s" value="<?php the_search_query(); ?>" placeholder="<?php esc_html_e('Type to search and hit enter...', 'grandportfolio' ); ?>">
					</form>
    			</div>
			    ...
			    <div class="post_header search">
			    	...
			    	<div class="post_detail">
					    ...
					    <?php
					    	...
					    	{
					    ?>
					    	<?php echo esc_html_e('In', 'grandportfolio' ); ?>
					    <?php
...
<?php endwhile; endif; ?>
		...
		<?php
		    ...
		    <div class="pagination_detail">
		     	...
		     	?>
		     	<?php esc_html_e('Page', 'grandportfolio' ); ?> <?php echo esc_html($paged); ?> <?php esc_html_e('of', 'grandportfolio' ); ?> <?php echo esc_html($wp_query->max_num_pages); ?>
		     </div>
		     <?php
		     }
		?>
