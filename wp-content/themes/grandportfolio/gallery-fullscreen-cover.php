...
?>		
	...
	<div id="fullscreen_gallery_content_wrapper">
		<div class="fullscreen_gallery_content">
			...
			<a href="javascript:;" id="fullscreen_gallery_view" class="button whitebg"><?php esc_html_e('View Gallery', 'grandportfolio' ); ?></a>
		</div>
	</div>
...
<?php
    ...
    foreach($all_photo_arr as $photo_id)
	{
		...
		{
			$image_title_html.= '<a href="'.esc_url($grandportfolio_purchase_url).'" class="button ghost"><i class="fa fa-shopping-cart marginright"></i>'.esc_html__('Purchase', 'grandportfolio' ).'</a>';
		}
?>
