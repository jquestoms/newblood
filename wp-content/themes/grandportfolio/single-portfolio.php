...
<div class="standard_wrapper">
	...
	<h6 class="subtitle"><span><?php esc_html_e('Recent Portfolios', 'grandportfolio' ); ?></span></h6><hr class="title_break"/>
	<br class="clear"/>
...
?>
	<div class="portfolio_recent_link">
		<a class="tooltip" href="<?php echo esc_url($tg_portfolio_url); ?>" title="<?php echo esc_attr(esc_html_e('View All Portfolios', 'grandportfolio' )); ?>"><i class="fa fa-th-large marginright middle"></i></h6></a>
	</div>
	<br class="clear"/>
<?php
	}
...
<?php
    ...
    $args = array(
    	'before'           => '<p>' . esc_html__('Pages:', 'grandportfolio'),
    	'after'            => '</p>',
    	'link_before'      => '',
    	'link_after'       => '',
    	'next_or_number'   => 'number',
    	'nextpagelink'     => esc_html__('Next page', 'grandportfolio'),
    	'previouspagelink' => esc_html__('Previous page', 'grandportfolio'),
    	'pagelink'         => '%',
    	'echo'             => 1
    );
    wp_link_pages($args);
...
<?php
    ...
    if(empty($prev_post) OR $prev_post->ID == $post->ID)
    {
    	$prev_post = '';
    }
    ...
    if(empty($next_post) OR $next_post->ID == $post->ID)
    {
    	$next_post = '';
    }
?>
