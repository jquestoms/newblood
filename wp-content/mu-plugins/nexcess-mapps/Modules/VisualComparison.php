...
class VisualComparison extends \StellarWP\PluginFramework\Modules\VisualComparison implements LoadsConditionally {
	...
	public function registerSetting() {
		...
		// Workaround for the issue with saving the setting value within the gui on first attempt.
		add_option( self::SETTING_NAME, [], '', true );
	}
