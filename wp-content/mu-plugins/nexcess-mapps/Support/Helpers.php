...
class Helpers {
	 ...
	 */
	public static function base64_urlencode( $value ) {
	 ...
	 */
	public static function base64_urldecode( $value ) {
	 ...
	 */
	public static function truncate( $value, $before, $after, $separator = '…' ) {
		...
		$beginning = $before > 0 ? mb_substr( $value, 0, $before ) : '';
		$remaining = mb_substr( $value, mb_strlen( $beginning ) );
