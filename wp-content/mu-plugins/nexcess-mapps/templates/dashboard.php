...
<div class="mapps-layout-fluid">
	...
	<div id="plan-details" class="mapps-sidebar card">
		...
		<p><a href="<?php echo esc_attr( Helpers::getPortalUrl( $settings->plan_id, $settings->account_id ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to Nexcess Portal', 'nexcess-mapps' ); ?></a></p>
	</div>
</div>
