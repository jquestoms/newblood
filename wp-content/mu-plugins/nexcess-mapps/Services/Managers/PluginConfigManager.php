...
class PluginConfigManager {
	 ...
	 *
	 * @param string $class_name Optional. Filter results to those of a specific class. Default is empty,
	 *                           meaning all resolved instances will be returned.
	 *
	 * @return Array<string,Plugin>
	 */
	public function resolved( $class_name = '' ) {
		return empty( $class_name )
			? $this->resolved
			: array_filter( $this->resolved, function ( $instance ) use ( $class_name ) {
