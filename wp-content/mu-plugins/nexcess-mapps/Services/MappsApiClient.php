...
class MappsApiClient {
	...
	public function purgeCaches() {
		...
		// Bail if flushed within the rate-limit period.
		if ( get_transient( 'nexcess_cdn_flushed' ) ) {
			return new WP_Error(
				'nexcess_cdn_flush_rate_limit',
				__( 'CDN cannot be flushed at this time. Please wait 5 minutes and try again.', 'nexcess-mapps' )
			);
		}
		...
		set_transient( 'nexcess_cdn_flushed', 1, 5 * MINUTE_IN_SECONDS );
