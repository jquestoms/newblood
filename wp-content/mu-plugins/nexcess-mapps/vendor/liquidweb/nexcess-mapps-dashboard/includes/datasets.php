	...
	if ( false !== $maybe_mwch ) {
		...
		return array(
			...
			'subtitles' => array(
				...
				'If you believe your site is missing a plugin from this list, <strong>please contact our support team and we will assist you.</strong> Please note that this includes iThemes Sync, Abandoned Cart By Jilt, Dokan Pro, Shopmaster, and Glew Reporting which are currently installed upon request.',
			),
		);
		...
		return array(
			...
			'subtitles' => array(
				...
				'If you believe your site is missing a plugin from this list, <strong>please contact our support team and we will assist you.</strong> Please note that this includes iThemes Sync, which is currently installed upon request.',
			),
		);
