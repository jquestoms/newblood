...
/**
 * Display a notice if the user is on WP Lite plan, which doesn't include premium plugins.
 */
function display_wp_lite_upgrade() {
	echo '<div class="wrap nexcess-mapps-dashboard-page-wrap">';
	echo '<h1 class="nexcess-mapps-dashboard-intro-headline">' . esc_html( get_admin_page_title() ) . '</h1>';
	echo '<div class="notice notice-info inline">';
	echo '<p><strong>' . esc_html__( 'No plugins available.', 'nexcess-mapps-dashboard' ) . '</strong></p>';
	echo '<p>' . wp_kses_post( sprintf(
		/* Translators: %1$s is the Support tab URL of the Nexcess dashboard. */
		__( 'To install premium plugins from Nexcess, consider upgrading your WP Lite plan. For more help, <a href="%1$s">please contact Nexcess support</a>.', 'nexcess-mapps-dashboard' ),
		admin_url( 'admin.php?page=nexcess-mapps#support' )
	) ) . '</p>';
	echo '</div>';
	echo '</div>';
