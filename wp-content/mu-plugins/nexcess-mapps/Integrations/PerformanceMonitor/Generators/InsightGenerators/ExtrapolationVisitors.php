...
class ExtrapolationVisitors extends BaseInsightTypeGenerator {
	...
	public function generate() {
		...
		foreach ( $this->pageDTOs as $page_dto ) {
			$load_time      = $this->getPageMetric( $page_dto, 'load_time' );
			$load_time_diff = $this->getPageMetric( $page_dto, 'load_time_diff' );
		...
		if ( $bounce_rate_probability_on_average >= self::SENSITIVITY_PERCENTS ) {
			$variable_dto     = new VariableDTO( 'percent', (string) $bounce_rate_probability_on_average );
