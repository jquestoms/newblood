...
class ReportGenerator extends BaseGenerator {
	...
	public function generate() {
		...
		$post_meta = [
			...
			'global_performance' => $this->getGlobalPerformanceData(),
		];
	...
	/**
	 * @return array Global performance data.
	 */
	protected function getGlobalPerformanceData() {
		$data = [];

		foreach ( $this->globalPerformanceReports as $region => $reports ) {
