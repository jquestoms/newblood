...
class WooCommerceCartFragments extends Integration {
	...
	protected function getFilters() {
		return [
			[ 'woocommerce_get_script_data', [ $this, 'limitCartFragmentsExecution' ], 10, 2 ],
	 ...
	 */
	public function saveValue( $key, $new_value, $prev_value ) {
		...
		$this->getOption()->set( self::IS_ACTIVE, (bool) $new_value )->save();
		$this->getOption()->set( self::CART_FRAGMENTS_STATUS, (bool) $new_value )->save();
	}
	...
	/**
	 * Limits the cart fragments JS execution.
	 *
	 * @param mixed[] $script_data Script parameters data.
	 * @param string  $handle      Script handle the data will be attached to.
	 *
	 * @return mixed[]|null
	 */
	public function limitCartFragmentsExecution( $script_data, $handle ) {
		if ( 'wc-cart-fragments' === $handle && $this->shouldDequeueCartFragments() ) {
			return null;
		}
