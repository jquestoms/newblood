...
class Settings {
	 ...
	 */
	const MIN_SUPPORTED_PHP_VERSION = '7.0';
	...
	private function loadEnvironmentVariables() {
		...
		$plan_type = ! empty( $this->getConfig( 'app_type_actual', false ) ) ? $this->getConfig( 'app_type_actual' ) : $this->getConfig( 'app_type', 'unknown' );
		...
		$settings = array_merge( $environment, [
			...
			'is_lite'              => in_array( $environment['package_label'], self::LITE_PLANS, true ),
	...
	private function loadSiteWorxEnvironment() {
		...
		set_site_transient( self::ENVIRONMENT_TRANSIENT, $return, DAY_IN_SECONDS );
